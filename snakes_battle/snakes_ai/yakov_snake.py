...
class Yakov(Snake):
    ...
    def get_best(self,fruits ,snakes):
        ...
        #     if times >10:
        #         close = self.force_next(fruits, my_position[0],bads, direction)
        #     else:
        #         times+=1
        #         bads.append(close)
    ...
    # def force_next(self,direction,head,snakes, my_snake , fruits):
    #     next = [0,0]
    #     if direction == Direction.RIGHT:
    #         next = [head[0]+1,head[1]]
    #     elif direction == Direction.LEFT:
    ...
    def make_decision(self, board_state):
        ...
        close = self.get_best(fruits, snakes)
